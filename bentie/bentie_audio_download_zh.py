...
download_directory = os.path.join(get_base_path(), "audio/bentie_audio_zh")
...
async def fetch_character_data(session, character_name,log_func=None):
    new_url = f"https://honkai-star-rail.fandom.com/wiki/{character_name}/Voice-Overs/Chinese"
